...
export default function AboutPage_Mobile() {
            ...
            </div> : <></>}
            {
                !menuvisible ? (
                    <div className='slide-up-animation' style={{ overflowX: 'hidden' }}>
                        ...
                        <div className="jnvvnfnvf">
                            <div className="njvfnvkf">
                                Crafting innovative web and mobile app solutions that thrive in the digital world.
                            </div>
                            <div className="divider" style={{ width: '100vw' }}></div>
                            <div className="kkfkfk" >
                                <div className="mfnjfnjvn">
                                ...
                                <div className="mdnjvndvn">
                                    <div className="jhfjv" style={{ marginTop: '-1px' }}>
                                        <svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1">
                                            <title>arrow-up-right</title>
                                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                <g transform="translate(-1019.000000, -279.000000)" stroke="#000000" strokeWidth="1.5">
                                ...
                                <div className="mdnjvndvn" style={{ display: 'flex', flexDirection: 'row', gap: "20px", flexWrap: 'wrap', width: '100vw', justifyContent: 'center', display: 'flex', left: '-23px' }}>
                                ...
                                <br /><br />
                                <div className="mdnjvndvn">
                                    <div className="ldkd" style={{ marginTop: '2px' }}>
                                        <svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1">
                                            <title>arrow-up-right</title>
                                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                <g transform="translate(-1019.000000, -279.000000)" stroke="#000000" strokeWidth="1.5">
                                ...
                                <div className="ndjnjdnv" style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
